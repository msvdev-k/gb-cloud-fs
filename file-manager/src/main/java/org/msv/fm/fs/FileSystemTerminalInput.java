...
public interface FileSystemTerminalInput {
    ...
    /**
     * Метод вызываемый при добавлении файла или каталога в файловую систему терминала.
     *
     * @param path путь к добавленному файлу или каталогу в файловой системе терминала
     */
    void fileAdded(String path);


    /**
     * Метод вызываемый при переименовании файла или каталога в файловую систему терминала.
     * @param path путь к переименованному файлу или каталогу в файловой системе терминала
     */
    void fileRenamed(String path);


    /**
     * Метод вызываемый при удалении файла или каталога в файловую систему терминала.
     * @param path путь к удалённому файлу или каталогу в файловой системе терминала (файла уже не существует!)
     */
